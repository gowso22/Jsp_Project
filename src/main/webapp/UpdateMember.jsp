...
<script type="text/javascript">
	function CheckEditMember() {
		...
		var editForm = document.EditMember;

		var pwd = editForm.pwd.value;
		var pwd_confirm = editForm.pwd_confirm.value;
...
<body>
	...
	<div class="join_sec">
		...
		<div class="join_form">
			<form name="EditMember" class="form-signin"
				action="MemberUpdateAction.do" method="post">
				<div class="form-group  row">
					<span>아이디 </span> <BR> <BR> <input name="id" type="text"
						class="form-control" placeholder="아이디"
						value="<%=rs.getString("id")%>" readonly="readonly">
				</div>
				<div class="form-group  row">
				...
				<div class="form-group  row ">
					...
					<div class="col-sm-10">
						<input type="text" name="email1" maxlength="50"
							class="form-control" value="<%=rs.getString("email1")%>">@
				...
				<div class="form-group  row">
					<span>전화번호 (010 포함 '-' 빼고 입력)</span> <input name="phone"
						type="text" class="form-control" placeholder="예시)01012341234"
				...
				<div class="form-group  row">
					<div class="col-sm-offset-2 col-sm-10 ">
						<input type="button" class="btn btn-primary " value="수정"
							onclick="CheckEditMember()"> <input type="reset"
							class="btn btn-primary " value="취소 " onclick="reset()"> <input
